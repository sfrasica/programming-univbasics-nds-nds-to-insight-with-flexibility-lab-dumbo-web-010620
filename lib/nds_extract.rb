...
def movies_with_director_key(name, movies_collection)
  ...
  result# GOAL: For each Hash in an Array (movies_collection), provide a collection
...
def gross_per_studio(collection)
 ...
 result# GOAL: Given an Array of Hashes where each Hash represents a movie,
...
def movies_with_directors_set(source)
 ...
 a_o_a_movies_by_dir# GOAL: For each director, find their :movies Array and stick it in a new Array
  #
  # INPUT:
